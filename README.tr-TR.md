...
<img width="900" height="180" alt="yeni-açık" src="https://github.com/user-attachments/assets/0e6751fb-4196-4f09-9a64-818bda07f343" />

<img width="1000" height="180" alt="yeni-kapalı" src="https://github.com/user-attachments/assets/13810712-12df-4bea-bdfd-5e86f3d7686e" />

### Arayüz önizlemesi

<img width="800" height="400" alt="önizleme1" src="https://github.com/user-attachments/assets/aa4e4889-33b0-4860-b973-61baf1e7f57e" />
<img width="800" height="600" alt="önizleme2" src="https://github.com/user-attachments/assets/466e4509-af6a-4bb0-9e31-55b4cf7799e1" />
<img width="800" height="800" alt="önizleme3" src="https://github.com/user-attachments/assets/332d471d-85b0-4aa5-8aef-e9a674bd179d" />
...
> Diğer dil klasörleri (`zh-TW/`, `en-US/`, `ja-JP/`, `ko-KR/`, `ru-RU/`, `fr-FR/`, `de-DE/`, `es-ES/`, `it-IT/`, `pt-BR/`, `ar-SA/`, `tr-TR/`, `fa-IR/`, `he-IL/`) aynı yapıyı paylaşır ve güncel dile göre yüklenir; `en-US/`, Çin dışı eklentilerin düğümlerini İngilizce'ye geri döndürmek için kullanılır.

### Özel çeviri ekleme

`zh-CN/Nodes/` altında bir JSON dosyası oluşturun:
...
`zh-CN/Menus/` altında bir JSON dosyası oluşturun ve menü çevirileri ekleyin:
...
│         │                             │                │
│         ▼                             ▼                │
│   zh-CN/ çeviri verisi         MutationObserver        │
